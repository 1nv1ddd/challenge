"""HTTP-слой роутера hub: POST /api/checkpoints не падает на не-объектном теле."""
...
class TestCreateCheckpointApi(unittest.TestCase):
    """POST /api/checkpoints: тело-не-объект не должно давать 500."""
    ...
    def test_string_body_no_500(self) -> None:
        ...
        with TestClient(app) as client:
            r = client.post("/api/checkpoints", json="hello")
